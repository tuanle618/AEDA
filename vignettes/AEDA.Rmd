...
Following code snippets are needed in order to create multidimensional scaling report:
...
Like principal component as well as multidimensioanl scaling its purpose is dimension reduction. It's a way to find hidden patterns, show how those patterns overlap and show what characteristics are seen in multiple patterns.
