...
```{r loadPCAObj_zpcU1OpxESKXhm0j, echo = FALSE, message = FALSE, warning = FALSE}
...
zpcU1OpxESKXhm0j = readRDS("zpcU1OpxESKXhm0j.rds")
```
...
```{r showRotationAndSD_zpcU1OpxESKXhm0j, echo = FALSE, message = FALSE, warning = FALSE}
dt = DT::datatable(zpcU1OpxESKXhm0j$pca.result$pca.result$rotation, class = 'compact', filter = 'bottom', options = list(pageLength = 5),
...
The variances of the 1. to 4. principial component are: `r head(zpcU1OpxESKXhm0j$pca.result$pca.result$sdev) ` .
...
```{r showScreePlot_zpcU1OpxESKXhm0j, echo = FALSE, message = FALSE, warning = FALSE, out.width = '90%'}
zpcU1OpxESKXhm0j$pca.result$plotlist$pca.scree
```
...
```{r showScatterPlot_zpcU1OpxESKXhm0j, echo = FALSE, message = FALSE, warning = FALSE, out.width = '90%'}
zpcU1OpxESKXhm0j$pca.result$plotlist$pca.scatter.1
```
