...
```{r showMDSdf_zyBopDGghMyFVd5F, echo = FALSE, message = FALSE, warning = FALSE}
dt = DT::datatable(zyBopDGghMyFVd5F$mds.analysis$mds.result.data, class = 'compact', filter = 'bottom', options = list(pageLength = 10),
...
```{r showMDSPlot_zyBopDGghMyFVd5F, echo = FALSE, message = FALSE, warning = FALSE, out.width = '90%'}
zyBopDGghMyFVd5F$mds.analysis$mds.plot
```
