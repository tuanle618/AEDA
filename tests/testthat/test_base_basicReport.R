...
test_that("makeReportTask",{
  ...
  expect_class(basic.report.task, "ReportTask")
  ...
  basic.report.task = makeReportTask(id = "test.report", data = airquality, target = NULL)
...
test_that("makeBasicReport",{
  ...
  expect_identical(basic.report$report.task, basic.report.task)
  ...
  expect_error(makeBasicReport(basic.report.task))
